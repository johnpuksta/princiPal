---
name: build-vsix
description: Build the VsDebugBridge VSIX extension for Visual Studio 2022
allowed-tools: Bash
---
...
1. Build the VSIX project:
   ```
   dotnet build C:/Repos/VsDebugBridge/src/VsDebugBridge.VsExtension/VsDebugBridge.VsExtension.csproj -c Release
   ```

2. Report the build result. The output DLL is at:
   ```
   C:/Repos/VsDebugBridge/src/VsDebugBridge.VsExtension/bin/Release/net48/VsDebugBridge.VsExtension.dll
   ```
